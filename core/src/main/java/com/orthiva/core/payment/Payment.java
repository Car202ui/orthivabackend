...
public class Payment extends BaseEntity {
    ...
    public enum Purpose { DIAGNOSIS, TREATMENT }

    public enum Status { PENDING, APPROVED, DECLINED, REFUNDED, ERROR }
    ...
    public static Payment pending(UUID tenantId, UUID orderId, UUID planId, Purpose purpose, BigDecimal amount,
