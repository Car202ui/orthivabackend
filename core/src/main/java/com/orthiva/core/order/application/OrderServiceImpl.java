...
class OrderServiceImpl implements OrderService {
    ...
    OrderServiceImpl(OrderRepository orders, OrderStatusHistoryRepository history, OrderWorkflow workflow,
                     PatientService patients, MediaService media, IdentityService identity) {
        this.orders = orders;
